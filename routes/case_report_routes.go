...
func CaseReportRoute(router *mux.Router) {
	...
	router.HandleFunc("/case-reports-detailed", controllers.GetAllCaseReportsDetailed()).Methods("GET")
	router.HandleFunc("/case-reports-summarized", controllers.GetAllCaseReportsSummarized()).Methods("GET")
